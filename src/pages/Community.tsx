        ...
        <Box className="communityIntro">
          ...
          <Box className="communityActions">
            ...
            <Stack direction="row" spacing={3} className="communityActionsLinks">
              <Typography component="a" href="https://tally.so/r/MeJXkp" target="_blank" rel="noopener noreferrer" className="communityActionLink">
                Employer
              </Typography>
              <Typography component="a" href="https://tally.so/r/WOM2xN" target="_blank" rel="noopener noreferrer" className="communityActionLink">
                Community Spotlight
              </Typography>
            </Stack>
          </Box>
              ...
              {filteredPosts.map((post) => (
                <Box key={post._id} className="communityGridItem">
                  <Box
                    ...
                    style={{
                      backgroundImage: `linear-gradient(150deg, rgba(7,0,0,0.55), rgba(0,0,0,0.25)), url(${urlFor(post.heroImage)?.width(1200).height(900).fit('crop').url() || ''})`,
                    }}
                  >
